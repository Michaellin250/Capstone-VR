...
namespace _VIRAL._03_Scripts
{
	public class Hand : MonoBehaviour
	{
		...
		[Space] [SerializeField] public Transform IndexProximal;
		...
		{
			CheckGrasping();
			Debug.Log("Position: " + _ovrHand.transform.position);
			Debug.Log("Local Position: " + _ovrHand.transform.localPosition);
		}
