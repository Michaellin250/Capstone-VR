...
namespace _VIRAL._03_Scripts
{
	...
	public class Holdable : MonoBehaviour
	{
	    ...
	    [SerializeField] private bool _restrictHolderTypes= false;
		...
		[SerializeField] protected float _handSpring = 3000f;
		[SerializeField] protected float _handAngularSpring = 1000f;
		[SerializeField] protected float _handDamper = 100f;
		[SerializeField] protected float _handBreakForce = 5000f;

		[SerializeField] private Transform _visualSnapHandRight;
		[SerializeField] private Transform _visualSnapHandLeft;
        ...
        public bool RestrictHolderTypes => _restrictHolderTypes;

        public List<HolderType> AllowedHolderTypes => _allowedHolderTypes;

        public Transform VisualSnapHandRight => _visualSnapHandRight;
        public Transform VisualSnapHandLeft => _visualSnapHandLeft;
		...
		private void CreateJoint(Holder holder)
		{
			...
			if (holder.GetComponent<HandGrabber>())
			{
				...
				spring = _handSpring;
				angularSpring = _handAngularSpring;
				damper = _handDamper;
				maximumForce = 10000;
				_capturePoint = transform.InverseTransformPoint(holder.transform.position);
				
				_joint.breakForce = _handBreakForce;
				_joint.breakTorque = _handBreakForce;
			}
			else
			{
				// SLOT
